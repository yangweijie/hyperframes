...
!(function (t, e) {
  ...
  function fb(r) {
    return (
      ...
      function (t) {
        ...
        return Pt(
          t,
          e.querySelectorAll ? e : e === r ? T("Invalid scope") || a.createElement("div") : r,
        );
      }
    );
  }
      ...
      function (t, e, r) {
        ...
        if (!d) {
          if (!(f = "auto" === p.grid ? 0 : (p.grid || [1, X])[1])) {
            for (h = -X; h < (h = r[f++].getBoundingClientRect().left) && f < c; );
            f < c && f--;
          }
          for (
            d = y[c] = [],
        ...
        return ((c = (d[t] - d.min) / d.max || 0), la(d.b + (_ ? _(c) : c) * d.v) + d.u);
      }
    );
  }
  function ib(i) {
  ...
  function jb(h, e) {
    ...
    return (
      !r &&
        v(h) &&
        ((l = r = h.radius || X),
        h.values ? ((h = Pt(h.values)), (f = !t(h[0])) && (l *= l)) : (h = ib(h.increment))),
      Za(
        e,
        r
          ? s(h)
            ...
            : function (e) {
                for (
                  ...
                  (r = f ? (r = h[u].x - n) * r + (i = h[u].y - a) * i : Math.abs(h[u] - n)) < s &&
                    ((s = r), (o = u));
                return ((o = !l || s <= l ? h[o] : e), f || o === e || t(e) ? o : o + _a(e));
              }
          : ib(h),
      )
    );
        ...
        var e = t.name,
          ...
          i =
            e && !r && t.init
              ...
              : t,
          n = { init: V, render: _e, add: $t, kill: Te, modifier: ve, rawVars: 0 },
          a = { targetTest: 0, get: 0, getSetter: ue, aliases: {}, register: 0 };
        if ((Lt(), t !== i)) {
          if (mt[e]) return;
          (ta(i, ta(xa(t, n), a)),
  ...
  function Db(e, r, i) {
    ...
    if (!p) {
      if (("," === e.substr(-1) && (e = e.substr(0, e.length - 1)), Rt[e])) p = Rt[e];
      else if ("#" === e.charAt(0)) {
        if (
          (e.length < 6 &&
            (e =
  ...
  var Gt = (function (i) {
    ...
    return (
        ...
        if ((this !== L && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
          if (
            ...
            if (
              ...
              if (
                ...
                this.vars.repeatRefresh && !p && ((this.invalidate()._lock = 1), (c = s)),
                (_ && _ !== this._time) ||
                  u != !this._ts ||
          ...
          if (
            ...
            this._initted ||
              ...
              (this._zTime = t),
              (_ = 0)),
            !_ && v && g && !e && !c && (At(this, "onStart"), this._tTime !== v))
          )
            return this;
          if (_ <= i && 0 <= t)
            for (n = this._first; n; ) {
            ...
            ((v === m && this._tTime >= this.totalDuration()) || (!v && _)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                ...
                e ||
                  (t < 0 && !_) ||
                  (!v && !_ && m) ||
                  (At(this, v === m && 0 <= t ? "onComplete" : "onReverseComplete", !0),
      ...
      (e.killTweensOf = function killTweensOf(t, e, r) {
        for (var i = this.getTweensOf(t, r), n = i.length; n--; ) Zt !== i[n] && i[n].kill(t, e);
        return this;
      }),
  ...
  function cc(t, e, i, n, a, o) {
    ...
    if (
      ...
      ((i._pt = h = new we(i._pt, a, t, 0, 1, u.render, u, 0, u.priority)), i !== c)
    )
  ...
  var Zt,
    ...
    $t = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
      ...
      if (
        (r(n) &&
          ...
          "=" === n.charAt(1) && ((!(c = ma(p, n) + (_a(p) || 0)) && 0 !== c) || (n = c))),
        !f || p !== n || Wt)
      )
        return isNaN(p * n) || "" === n
          ? (d || e in t || S(e, n),
    ...
    Ht = function _initTween(t, e, r) {
      ...
      if (
        ...
        for (t._pt = t._ptCache = 0, T = (C && w(T)) || (T && !C), n = 0; n < S.length; n++) {
          if (
            ...
            for (a in i)
              mt[a] && (f = cc(a, i, t, d, o, D))
                ? f.priority && (u = 1)
                : (c[a] = s = $t.call(t, o, a, "get", i[a], d, D, 0, m.stringFilter));
          (t._op && t._op[n] && t.kill(o, t._op[n]),
            z &&
              t._pt &&
              ((Zt = t), L.killTweensOf(o, c, t.globalTime(e)), (_ = !t.parent), (Zt = 0)),
            t._pt && T && (_t[h.id] = 1));
        }
    ...
    Jt = Tt + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert",
    Kt = {};
  ...
  var te = (function (E) {
    function Tween(e, r, i, n) {
      ...
      if (
        ((a._targets = P.length
          ? ga(P)
          : T("GSAP target " + e + " not found. https://gsap.com", !Y.nullTargetWarn) || []),
        (a._ptLookup = []),
        (a._overwrite = x),
        k || b || y(_) || y(m))
      ) {
        ...
        if (
          ...
          for (o = 0; o < h; o++)
            (((u = xa(r, Kt)).stagger = 0),
              ...
              (u.delay = (+Qt(m, _assertThisInitialized(a), o, f, P) || 0) - a._delay),
              !b &&
                1 === h &&
                u.delay &&
          ...
          (ya(ta(s.vars.defaults, { ease: "none" })), (s._ease = jt(k.ease || r.ease || "none")));
          var A,
            D,
            z,
            R = 0;
          if (K(k))
            ...
            for (l in ((u = {}), k)) "ease" === l || "easeEach" === l || ic(l, k[l], u, k.easeEach);
            for (l in u)
              for (
                ...
                (((z = { ease: (D = A[o]).e, duration: ((D.t - (o ? A[o - 1].t : 0)) / 100) * _ })[
                  l
                ] = D.v),
                  s.to(P, z, R),
                  (R += z.duration));
      ...
      return (
        !0 !== x || F || ((Zt = _assertThisInitialized(a)), L.killTweensOf(P), (Zt = 0)),
    ...
    return (
        ...
        if (d) {
          if (
            ...
            if (!this._initted) {
              ...
              if (!(f === this._time || (r && this.vars.repeatRefresh && a !== o))) return this;
            ...
            if (this._rEase) {
              ...
              this.ratio = h =
                this._invRatio +
                this._invScale * this._invEase((i - this._invTime) * this._invRecip);
            ...
            ((l && l.render(t < 0 ? t : l._dur * l._ease(i / this._dur), e, r)) ||
              ...
              this._onUpdate && !e && (p && Fa(this, t, 0, r), At(this, "onUpdate")),
              this._repeat &&
                a !== o &&
                this.vars.onRepeat &&
                !e &&
            ...
            if (
              ...
              (e < 0 && Fa(t, e, 0, !0),
                ...
                (e >= t._tDur || e < 0) &&
                  ...
                  r ||
                    I ||
                    (At(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom())));
              ...
              for (c = t._ptCache[e] = [], l = t._ptLookup, f = t._targets.length; f--; ) {
                ...
                if (!u)
                  return (
                    ...
                    (Wt = 0),
                    o
                      ? T(e + " not eligible for reset. Try splitting into individual properties")
                      : 1
                  );
                c.push(u);
              }
            for (f = c.length; f--; )
              (((u = (h = c[f])._pt || h).s = (!i && 0 !== i) || n ? u.s + (i || 0) + a * u.c : i),
                (u.c = r - u.s),
                h.e && (h.e = ka(r) + _a(h.e)),
                h.b && (h.b = u.s + _a(h.b)));
          })(this, t, e, r, i, a, s, n)
      ...
      (e.kill = function kill(t, e) {
        ...
        if (this.timeline) {
          ...
          return (
            this.timeline.killTweensOf(t, e, Zt && !0 !== Zt.vars.overwrite)._first || wb(this),
            this.parent &&
        ...
        (s.queries = t)))
          "all" === n
            ...
            : (i = h.matchMedia(t[n])) &&
              ...
              (o[n] = i.matches) && (a = 1),
              i.addListener ? i.addListener(Hc) : i.addEventListener("change", Hc));
        return (
          a &&
            e(s, function (t) {
              return s.add(null, t);
  ...
  var Ee = {
    ...
    quickSetter: function quickSetter(r, e, i) {
      ...
      var s = mt[e],
        ...
        h = s
          ? function (t) {
              var e = new s();
              ((c._pt = 0), e.init(r, i ? t + i : t, c, 0, [r]), e.render(1, e), c._pt && _e(1, c));
            }
          : o.set(r, u);
      return s
        ? h
    ...
    exportRoot: function exportRoot(t, e) {
      ...
      for (
        ...
        ((i = r._next),
          (!e && !r._dur && r instanceof te && r.vars.onComplete === r._targets[0]) ||
            ...
            for (r in e)
              for (i = a.length; i--; )
                (n = (n = t._ptLookup[i][r]) && n.d) &&
                  (n._pt && (n = Lc(n, r)), n && n.modifier && n.modifier(e[r], t, a[i], r));
          })(t, n);
        };
      },
    };
  ...
  function Md(t, e) {
    ...
    if (t in ur && n) {
      ...
      if (
        ...
        return;
      (a.svg && ((this.svgo = i.getAttribute("data-svg-origin")), this.props.push(gr, e, "")),
        (t = mr));
    }
    ...
    for (t = 0; t < r.length; t += 3)
      r[t + 1]
        ...
        : r[t + 2]
          ? (n[r[t]] = r[t + 2])
          : n.removeProperty(
              "--" === r[t].substr(0, 2) ? r[t] : r[t].replace(cr, "-$1").toLowerCase(),
            );
    if (this.tfm) {
      ...
      (a.svg && (a.renderTransform(), i.setAttribute("data-svg-origin", this.svgo || "")),
        ((t = je()) && t.isStart) ||
          ...
          a.zOrigin &&
            n[gr] &&
            ((n[gr] += " " + a.zOrigin + "px"), (a.zOrigin = 0), a.renderTransform()),
          (a.uncache = 1)));
    }
  }
  function Pd(t, e) {
  ...
  function Wd(t) {
    var e,
      r = t.ownerSVGElement,
      i = Rd("svg", (r && r.getAttribute("xmlns")) || "http://www.w3.org/2000/svg"),
      n = t.cloneNode(!0);
      ...
      (e in ur && e !== gr && (e = mr),
        i.removeProperty
          ? (("ms" !== (r = e.substr(0, 2)) && "webkit" !== e.substr(0, 6)) || (e = "-" + e),
            i.removeProperty("--" === r ? e : e.replace(cr, "-$1").toLowerCase()))
          : i.removeAttribute(e));
    }
  }
  ...
  function ce(t, e, r, i) {
    ...
    if (
      ...
      return (
        (n = o ? t.getBBox()[f ? "width" : "height"] : t[d]), ka(_ ? (u / n) * 100 : (u / 100) * n)
      );
    if (
      ((l[f ? "width" : "height"] = 100 + (p ? h : i)),
      (a =
        ("rem" !== i && ~e.indexOf("adius")) || ("em" === i && t.appendChild && !c)
          ? t
          : t.parentNode),
    ...
    if (!_ || ("height" !== e && "width" !== e))
      ((!_ && "%" !== h) || br[Sd(a, "display")] || (l.position = Sd(t, "position")),
  ...
  function ee(t, e, r, i) {
    if (!r || "none" === r) {
      var n = yr(e, t, 1),
        a = n && Sd(t, n, 1);
      a && a !== r ? ((e = n), (r = a)) : "borderColor" === e && (r = Sd(t, "borderTopColor"));
    }
    var s,
      o,
      u,
    ...
    if (
      ...
      (g.e = i),
      (r += ""),
      "var(--" === (i += "").substring(0, 6) && (i = Sd(t, i.substring(4, i.indexOf(")")))),
      "auto" === i &&
        ((f = t.style[e]), (t.style[e] = i), (i = Sd(t, e) || i), f ? (t.style[e] = f) : $d(t, e)),
      Ib((s = [r, i])),
      (i = s[1]),
      (u = (r = s[0]).match(nt) || []),
      (i.match(nt) || []).length)
      ...
      for (; (o = nt.exec(i)); )
        ((c = o[0]),
          ...
          c !== (f = u[y++] || "") &&
            ...
            _ || ((_ = _ || Y.units[e] || m), v === i.length && ((i += _), (g.e += _))),
            m !== _ && (h = ce(t, e, f, _) || 0),
            (g._pt = {
              _next: g._pt,
              p: p || 1 === y ? p : ",",
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if ("all" === o || !0 === o) ((s.cssText = ""), (i = 1));
        ...
        for (n = (o = o.split(",")).length; -1 < --n; )
          ((r = o[n]), ur[r] && ((i = 1), (r = "transformOrigin" === r ? gr : mr)), $d(a, r));
      i &&
        ($d(a, mr),
        u &&
  ...
  function ne(t, e) {
    ...
    return s.svg && t.getAttribute("transform")
      ...
      : (u !== Or ||
          ...
          a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : Be.removeChild(t))),
  ...
  function Ae(t, e, r) {
    ...
    for (n in (l.svg
      ...
      : ((a = getComputedStyle(r)[mr]), (f[mr] = e), (i = Cr(r, 1)), (f[mr] = a)),
    ur))
      (a = l[n]) !== (s = i[n]) &&
  ...
  var Ie,
    ...
    pr = /[\s,\(]\S/,
    _r = { autoAlpha: "opacity,visibility", scale: "scaleX,scaleY", alpha: "opacity" },
    mr = "transform",
    gr = mr + "Origin",
    ...
    yr = function _checkPropPrefix(t, e, r) {
      ...
      for (t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(vr[n] + t in i); );
    ...
    wr = function _get(t, e, r, i) {
      ...
      return (
        Ne || Vd(),
        e in _r && "transform" !== e && ~(e = _r[e]).indexOf(",") && (e = e.split(",")[0]),
        ur[e] && "transform" !== e
          ? ((n = Cr(t, i)),
            (n =
              "transformOrigin" !== e
          ...
          : ((n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(")) ||
            (n = (kr[e] && kr[e](t, e, r)) || Sd(t, e) || ia(t, e) || ("opacity" === e ? 1 : 0)),
    ...
    Cr = function _parseTransform(t, e) {
      ...
      return (
        ...
        r.svg &&
          ((M = r.uncache
            ? ((C = t.getBBox()), (N = r.xOrigin - C.x + "px " + (r.yOrigin - C.y) + "px"), "")
        ...
        m !== Or &&
          ...
          6 === m.length
            ? ((s = Math.sqrt(T * T + b * b)),
              (o = Math.sqrt(x * x + w * w)),
              (u = T || b ? fr(b, T) * hr : 0),
              (f = w || x ? fr(w, x) * hr + u : 0) && (o *= Math.abs(Math.cos(f * lr))),
        ...
        (r.zOrigin = parseFloat(N.split(" ")[2]) || (!e && r.zOrigin) || 0) && (F[gr] = Pr(N)),
    ...
    Er = function _renderSVGTransforms(t, e) {
      ...
      ((c = parseFloat(c)),
        ...
        (v || y || T || b) &&
          ((x = ka(x + v - (v * r + y * n) + T)), (k = ka(k + y - (v * i + y * a) + b))),
        (u || h) &&
          ((s = g.getBBox()),
  ...
  var Fr,
    ...
    Br = {
      ...
      init: function init(t, e, i, n, a) {
        ...
        (this.tween = i),
        e))
          if ("autoRound" !== c && ((o = e[c]), !mt[c] || !cc(c, e, i, n, t, a)))
            if (
              ((l = typeof o),
              (f = kr[c]),
              ...
              ((s = (getComputedStyle(t).getPropertyValue(c) + "").trim()),
                ...
                (Et.lastIndex = 0),
                Et.test(s) ||
                  ((d = _a(s)), (p = _a(o)) ? d !== p && (s = ce(t, c, s, p) + p) : d && (o += d)),
              ...
              if (
                (O && c in O
                  ? ((s = "function" == typeof O[c] ? O[c].call(i, n, t, a) : O[c]),
                    ...
                    _a(s + "") || "auto" === s || (s += Y.units[c] || _a(wr(t, c)) || ""),
                    "=" === (s + "").charAt(1) && (s = wr(t, c)))
                  : (s = wr(t, c)),
                (h = parseFloat(s)),
                ...
                c in _r &&
                  ("autoAlpha" === c &&
                    (1 === h && "hidden" === wr(t, "visibility") && u && (h = 0),
                ...
                if (
                  (this.styles.save(c), (w = o), "string" === l && "var(--" === o.substring(0, 6))
                ) {
                  if ("calc(" === (o = Sd(t, o.substring(4, o.indexOf(")")))).substring(0, 5)) {
                ...
                if (
                  (g ||
                    ...
                    ((g = this._pt =
                      new we(this._pt, k, mr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                  "scale" === c)
                )
                  ((this._pt = new we(
                    this._pt,
              ...
              if (m || ((u || 0 === u) && (h || 0 === h) && !pr.test(o) && c in k))
                ((u = u || 0),
                  (d = (s + "").substr((h + "").length)) !==
                    (p = _a(o) || (c in Y.units ? Y.units[c] : d)) && (h = ce(t, c, s, p)),
                  (this._pt = new we(
                    this._pt,
                    m ? v : k,
                    c,
                    h,
                    (_ ? ma(h, _ + u) : u) - h,
                    m || ("px" !== p && "zIndex" !== c) || !1 === e.autoRound ? xd : Bd,
                  )),
                  (this._pt.u = p || 0),
                  m && w !== o
                    ? ((this._pt.b = s), (this._pt.e = w), (this._pt.r = Ad))
                    : d !== p && "%" !== p && ((this._pt.b = s), (this._pt.r = zd)));
      ...
      render: function render(t, e) {
        if (e.tween._time || !je()) for (var r = e._pt; r; ) (r.r(t, r.d), (r = r._next));
